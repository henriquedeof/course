...
public interface CourseRepository extends JpaRepository<CourseModel, UUID>, JpaSpecificationExecutor<CourseModel> {
    ...
    @Modifying // Annotation used to allow the use of the @Query annotation to execute the insert statement and also because the query is not a SELECT
    ...
    @Modifying // Using this annotation because the query is not a SELECT
